...
?><?php  include("../../metasnode.php");  ?>
 <meta name="title" content="Just write">
 <meta name="description" content="Just write whatever you want to write"> 
 <meta name="keywords" content=", pdf, testing"> <meta name="robots" content="index, follow"> <meta http-equiv="Content-Type" content="text/html; charset=utf-8"> <meta name="language" content="English"> <meta name="revisit-after" content="1 days"> <meta name="author" content="aywriter ">
...
function unction2(e){  
    ...
    <div class="sect" style="background-image: url(img/main.jpg);
      ...
      background-size: cover 
                      "> 
    <tcont><topic> Just write</topic></tcont>
...
<br>substring with a string replacement or the returned value of replaceFunction.
<br>Note that this does not modify the string in place, but returns the string with replacements.
<br>var string = "Hello, World!";
<br>string = string.replace( "Hello", "Bye" );
<br>console.log( string ); // "Bye, World!"
<br>string = string.replace( /W.{3}d/g, "Universe" );
<br>console.log( string ); // "Bye, Universe!"
<br>replaceFunction can be used for conditional replacements for regular expression    </div>
